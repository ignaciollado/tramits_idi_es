...
$currentY = $pdf->getY();
$pdf->setY($currentY + 15);
$intro = str_replace("%SOLICITANTE%", $data['expediente']['empresa'], lang('isba_17_resolucion_revocacion_no_justificar.intro'));
...
$currentY = $pdf->getY();
$pdf->setY($currentY + 6);
$html = lang('isba_17_resolucion_revocacion_no_justificar.antecedentes');
$pdf->writeHTML($html, true, false, true, false, '');

$currentY = $pdf->getY();
$pdf->setY($currentY + 4);
$parrafo_1 = str_replace("%FECHARESPRESIDI%", date_format(date_create($data['configuracionLinea']['fechaResPresidIDI']),"d/m/Y"), lang('isba_17_resolucion_revocacion_no_justificar.antecedentes_1_4'));
...
if ($ultimaMejora[2] && $ultimaMejora[3]) {
    $parrafo_3m = str_replace("%FECHARECM%", date_format(date_create($ultimaMejora[2]),"d/m/Y") , lang('isba_17_resolucion_revocacion_no_justificar.doc_prop_resolucion_revocacion_por_no_justificar_p3m'));
...
$currentY = $pdf->getY();
$pdf->setY($currentY + 5);
$parrafo_6 = lang('isba_17_resolucion_revocacion_no_justificar.fundamentos_tit');
$html =  $parrafo_6;
$pdf->writeHTML($html, true, false, true, false, '');

$currentY = $pdf->getY();
$pdf->setY($currentY + 5);
$parrafo_7 = lang('isba_17_resolucion_revocacion_no_justificar.fundamentos_txt');
$html = $parrafo_7;
$pdf->writeHTML($html, true, false, true, false, '');
...
$currentY = $pdf->getY();
$pdf->setY($currentY + 25);
$parrafo_7 = lang('isba_17_resolucion_revocacion_no_justificar.propuesta_tit');
$html = $parrafo_7;
$pdf->writeHTML($html, true, false, true, false, '');

$currentY = $pdf->getY();
$pdf->setY($currentY + 5);
$parrafo_9 = lang('isba_17_resolucion_revocacion_no_justificar.propuesta_txt');
...
$currentY = $pdf->getY();
$pdf->setY($currentY + 5);
$parrafo_7 = lang('isba_17_resolucion_revocacion_no_justificar.recursos_tit');
$html = $parrafo_7;
$pdf->writeHTML($html, true, false, true, false, '');

$currentY = $pdf->getY();
$pdf->setY($currentY + 5);
$parrafo_7 = lang('isba_17_resolucion_revocacion_no_justificar.recursos_txt');
$html = $parrafo_7;
$pdf->writeHTML($html, true, false, true, false, '');

$currentY = $pdf->getY();
$pdf->setY($currentY + 10);
$firma = lang('isba_17_resolucion_revocacion_no_justificar.firma');
...
$pdf->Output(WRITEPATH.'documentos/'.$nif.'/informes/'.$numExped.'_res_revocacion_por_no_justificar.pdf', 'F');