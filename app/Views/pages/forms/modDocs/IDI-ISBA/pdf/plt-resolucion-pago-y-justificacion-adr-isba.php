...
$pdf->SetTitle("RESOLUCIÓN PAGO Y JUSTIFICACIÓN");
$pdf->SetSubject("RESOLUCIÓN PAGO Y JUSTIFICACIÓN");
$pdf->SetKeywords("INDUSTRIA 4.0, ISBA, PIMES, ADR Balears, GOIB");	
...
$currentY = $pdf->getY();
$pdf->setY($currentY + 2);
$parrafo_1_2_3 = str_replace("%RESPRESIDENTE%", $data['configuracion']['respresidente'], lang('isba_11_resolucion_pago_y_justificacion.fets_1_2_3'));
$parrafo_1_2_3 = str_replace("%BOIBNUM%", $data['configuracionLinea']['num_BOIB'], $parrafo_1_2_3);
$parrafo_1_2_3 = str_replace("%FECHAPUBBOIB%", date_format(date_create($data['configuracionLinea']['fecha_BOIB']),"d/m/Y"), $parrafo_1_2_3);
$parrafo_1_2_3 = str_replace("%CONVO%", $convocatoria, $parrafo_1_2_3);
$parrafo_1_2_3 = str_replace("%FECHASOL%", date_format(date_create($data['expediente']['fecha_REC']),"d/m/Y"), $parrafo_1_2_3);
$parrafo_1_2_3 = str_replace("%SOLICITANTE%", $data['expediente']['empresa'], $parrafo_1_2_3);
$parrafo_1_2_3 = str_replace("%NIF%", $data['expediente']['nif'], $parrafo_1_2_3);
$parrafo_1_2_3 = str_replace("%NUMREC%", $data['expediente']['ref_REC'], $parrafo_1_2_3);
$parrafo_1_2_3 = str_replace("%IMPORTEAYUDA%", $fmt->formatCurrency($data['expediente']['importe_ayuda_solicita_idi_isba'], "EUR"), $parrafo_1_2_3);
$parrafo_1_2_3 = str_replace("%IMPORTE_INTERESES%", $fmt->formatCurrency($data['expediente']['intereses_ayuda_solicita_idi_isba'], "EUR"), $parrafo_1_2_3);
$parrafo_1_2_3 = str_replace("%IMPORTE_AVAL%", $fmt->formatCurrency($data['expediente']['coste_aval_solicita_idi_isba'], "EUR"), $parrafo_1_2_3);
$parrafo_1_2_3 = str_replace("%ANYOS_DURACION_AVAL%", $data['expediente']['plazo_aval_idi_isba'], $parrafo_1_2_3);
$parrafo_1_2_3 = str_replace("%FECHA_AVAL%", date_format(date_create($data['expediente']['fecha_aval_idi_isba']),"d/m/Y"), $parrafo_1_2_3);
$parrafo_1_2_3 = str_replace("%IMPORTE_ESTUDIO%", $fmt->formatCurrency($data['expediente']['gastos_aval_solicita_idi_isba'], "EUR"), $parrafo_1_2_3);
$parrafo_1_2_3 = str_replace("%FECHA_NOTIFICACION_PR_PROV%", date_format(date_create($data['expediente']['fecha_not_propuesta_resolucion_prov']),"d/m/Y"), $parrafo_1_2_3);
$parrafo_1_2_3 = str_replace("%FECHA_NOTIF_PRPROV%", date_format(date_create($data['expediente']['fecha_not_propuesta_resolucion_prov']),"d/m/Y"), $parrafo_1_2_3);
$html = $parrafo_1_2_3;
$pdf->writeHTML($html, true, false, true, false, '');
...
$parrafo_7 = str_replace("%FECHA_SEDE_JUSTIFICACION%", date_format(date_create($data['expediente']['fecha_REC_justificacion']),"d/m/Y"), lang('isba_11_resolucion_pago_y_justificacion.fets_5_7'));
...
$parrafo_7 = str_replace("%IMPORTEAYUDA%", $fmt->formatCurrency($data['expediente']['importe_ayuda_solicita_idi_isba'], "EUR"), $parrafo_7);
$parrafo_7 = str_replace("%IMPORTE_INTERESES%", $fmt->formatCurrency($data['expediente']['intereses_ayuda_solicita_idi_isba'], "EUR"), $parrafo_7);
$parrafo_7 = str_replace("%IMPORTE_AVAL%", $fmt->formatCurrency($data['expediente']['coste_aval_solicita_idi_isba'], "EUR"), $parrafo_7);
$parrafo_7 = str_replace("%IMPORTE_ESTUDIO%", $fmt->formatCurrency($data['expediente']['gastos_aval_solicita_idi_isba'], "EUR"), $parrafo_7);
...
$parrafo_7 = str_replace("%FECHA_PROP_RESOL_PROVISIONAL%", $data['expediente']['fecha_firma_propuesta_resolucion_prov'], $parrafo_7);
$parrafo_7 = str_replace("%FECHA_NOTIF_PRPROV%", $data['expediente']['fecha_not_propuesta_resolucion_prov'], $parrafo_7);
$parrafo_7 = str_replace("%FECHA_PR_DEFINITIVA%", $data['expediente']['fecha_firma_propuesta_resolucion_def'], $parrafo_7);
$parrafo_7 = str_replace("%FECHA_NOTIF_PRPDEF%", $data['expediente']['fecha_not_propuesta_resolucion_def'], $parrafo_7);
...
$parrafo_5 = lang('isba_11_resolucion_pago_y_justificacion.fundamentosDeDerechoTxt_2');
$html = $parrafo_5;
$pdf->writeHTML($html, true, false, true, false, '');
...
$resolucion = str_replace("%IMPORTEAYUDA%", $fmt->formatCurrency($data['expediente']['importe_ayuda_solicita_idi_isba'], "EUR"), $resolucion);
/* $resolucion = str_replace("%IMPORTE_INTERESES%", money_format("%i ", $data['expediente']['intereses_ayuda_solicita_idi_isba']), $resolucion); */
$resolucion = str_replace("%IMPORTE_INTERESES%", $fmt->formatCurrency($data['expediente']['intereses_ayuda_solicita_idi_isba'], "EUR"), $resolucion);
/* $resolucion = str_replace("%IMPORTE_AVAL%", money_format("%i ", $data['expediente']['coste_aval_solicita_idi_isba']), $resolucion); */
$resolucion = str_replace("%IMPORTE_AVAL%", $fmt->formatCurrency($data['expediente']['coste_aval_solicita_idi_isba'], "EUR"), $resolucion);
...
$resolucion = str_replace("%IMPORTE_ESTUDIO%", $fmt->formatCurrency($data['expediente']['gastos_aval_solicita_idi_isba'], "EUR"), $resolucion);
