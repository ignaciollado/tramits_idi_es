...
/* 		$user->userName = $empresa;
		...
		$request->subject = lang('message_lang.titulo_justificacion_isba'); // "Sol·licitud d'ajuts per al disseny de plans de transformació digital en el marc del programa 'Idigital'";
		$request->message = lang('message_lang.subtitulo_justificacion_isba'); // "Convocatoria para la concesión de ayudas para el diseño de planes de transformación digital para el año 2020 destinados a la industria balear, en el marco de Idigital, estrategia de digitalización industrial.";					
